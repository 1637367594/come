    ...
    <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
            <template>
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="商品图像" prop="image"><div class="grid-content bg-purple" prop="image" v-model="ruleForm.image"> <el-upload
                                    class="upload-demo"
                                    drag
        ...
        created(){
            ...
            axios.get(`http://localhost:8000/admin/shop/products/${id}`).then(res=>{
                ...
                this.ruleForm = {
                    ...
                    image:product.image,
                    galleries:product.product_galleries.map(item=>{
                        return item.img
                    }),
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.put(`http://localhost:8000/admin/shop/products/${this.ruleForm.id}`,this.ruleForm).then(res => {
                            console.log(res);
                            this.$message({
                                message: '恭喜你，更新成功',
                                type: 'success'
